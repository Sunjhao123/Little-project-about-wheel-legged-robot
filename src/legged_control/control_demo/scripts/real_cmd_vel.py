...
def calculate_mini_4wd_link_velocity_steering(data):
    ...
    pub_vel_mini_4wd_base_footprint_velocity=rospy.Publisher('/wheeltec/mini_4wd_base_footprint_velocity/link_cmd_vel', Float64,queue_size=1)
    pub_vel_mini_4wd_base_footprint_steering=rospy.Publisher('/wheeltec/mini_4wd_base_footprint_steering/link_cmd_vel', Float64,queue_size=1)
    v=data.twist
    if(len(v) == 16):     
...
def calculate_mini_4wd_joint_velocity_steering(data):
    ...
    pub_vel_mini_4wd_left_front_wheel_joint = rospy.Publisher('/left_front_wheel_velocity/joint_cmd_vel', Float64, queue_size=1)
    pub_vel_mini_4wd_right_front_wheel_joint = rospy.Publisher('/right_front_wheel_velocity/joint_cmd_vel', Float64, queue_size=1)
    pub_vel_mini_4wd_left_rear_wheel_joint = rospy.Publisher('/left_rear_wheel_velocity/joint_cmd_vel', Float64, queue_size=1)
    pub_vel_mini_4wd_right_rear_wheel_joint = rospy.Publisher('/right_rear_wheel_velocity/joint_cmd_vel', Float64, queue_size=1)
    a=data.velocity
    #rospy.loginfo(a)
